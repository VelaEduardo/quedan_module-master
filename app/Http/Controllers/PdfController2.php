...
class PdfController2 extends Controller
{
    ...
    public function index2($id, $cant_num) //todo: INDEX
    {
  ...
  //? ------------------------- --------------------------------------
        ...
        $pdf = PDF::loadView('print_quedan2', compact('getQuedan','getFactura', 'getFacturados', 'getFacturatres','getFacturacuatro','NumConverted'));
